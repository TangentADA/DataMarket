    ...
    return (
      <Layout style={{ padding: '1rem' }}>
        <Content className='text-focus-in' style={{ ...contentStyle }}>
          ...
          <Paragraph>
            Whether you&rsquo;re deep in the charts, researching the next narrative or
          ...
          <Paragraph>
            ...
            world. Cardano&rsquo;s design philosophy of formal verification, predictable
          ...
          <Paragraph>
            Cardano&rsquo;s architecture aligns perfectly with YallaCap&rsquo;s mission:
